...
class MobileFavoritesShimmer extends StatefulWidget {
  ...
  const MobileFavoritesShimmer({super.key, required this.isGridView});

  @override
  State<MobileFavoritesShimmer> createState() => _MobileFavoritesShimmerState();
}

class _MobileFavoritesShimmerState extends State<MobileFavoritesShimmer>
