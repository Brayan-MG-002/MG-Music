...
class MobileHomeShimmer extends StatefulWidget {
  final bool isGridView;

  const MobileHomeShimmer({super.key, required this.isGridView});

  @override
  State<MobileHomeShimmer> createState() => _MobileHomeShimmerState();
}

class _MobileHomeShimmerState extends State<MobileHomeShimmer>
